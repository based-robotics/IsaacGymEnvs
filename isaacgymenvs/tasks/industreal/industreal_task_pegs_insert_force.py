...
In a nutshell, this is IndustRealTaskPegsInsert class, but we
augment with the force measurements and rewards

Can be executed with python train.py task=IndustRealTaskPegsInsertForce.
"""
...
class IndustRealTaskPegsInsertForce(IndustRealEnvPegs, FactoryABCTask):
    def __init__(
        self,
        cfg,
        rl_device,
    ...
    def _get_task_yaml_params(self):
        ...
        ppo_path = os.path.join(
            "train/IndustRealTaskPegsInsertForcePPO.yaml"
    ...
    def compute_observations(self):
        ...
        # depending on the source of force measurements, we should use different
        # tensors for the observations
        assert self.cfg_task.env.force_source in ["fts"], f"Unknown force source: {self.cfg_task.env.force_source}"
    ...
    def _update_rew_buf(self):
        ...
        # TODO: Add force-based reward here
